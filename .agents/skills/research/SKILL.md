...
to the repository root. Follow it before loading application profiles or state.
This is a workflow pointer, not a portal CLI. Do not duplicate the specification.
